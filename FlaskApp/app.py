...
def index():
	if request.method == 'POST':
		...
		cur.execute("INSERT INTO test(reviewerName,booktitle,reviewText,summary,overall,reviewTime) VALUES(%s, %s, %s,%s,%d,%x)"
                            ,(name,book_title,review,summary,overall,reviewTime))
